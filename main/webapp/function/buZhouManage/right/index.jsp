...
<link rel="stylesheet" type="text/css"
	href="../../common/jquery-easyui-1.4.3/demo/demo.css">
<script type="text/javascript"
	src="../../common/jquery-easyui-1.4.3/jquery.min.js"></script>
<script type="text/javascript"
...
<body>
	<table id="list_data" cellspacing="0" cellpadding="0">
		<thead>
			<tr>
				...
				<th data-options="field:'remark',width:500,align:'center'"
					nowrap="false">备注</th>
			</tr>
		</thead>
	</table>
	...
	<div id="dlg"
		...
		title="步骤信息编辑" style="width: 500px; height: 500px; padding: 10px;"
		data-options="
				iconCls: 'icon-save',
				buttons: [{
					text:'Ok',
		...
		<form method="post" id="frm1">
			<div style="margin-bottom: 20px">
				...
				<input class="easyui-textbox" name="name" id="name"
					style="width: 100%; height: 22px"> <input name="id"
					type="hidden" id="id">
			</div>
			<div style="margin-bottom: 20px">
				<div>remark:</div>
