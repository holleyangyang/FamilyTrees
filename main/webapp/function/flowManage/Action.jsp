...
<body>
    ...
    <thead> 
        <tr>  
        	<th data-options="field:'flowControolerActionId',width:0,hidden:true" >功能编号</th>
          	<th data-options="field:'actionName',width:250" >actionName</th>
			<th data-options="field:'controllerDesc',width:400" >Method</th>
...
$(function(){
	$('#dlg').dialog('close');
        ...
        fit: true,//自动大小 
        url:'/examForAPI/flowControllerAction/list/<%=request.getParameter("controllerMethodId")%>', 
        //sortName: 'code', 
        //sortOrder: 'desc', 
        remoteSort:false,  
        idField:'flowControolerActionId', 
        singleSelect:false,//是否单选 
        pagination:false,//分页控件 
        rownumbers:true,//行号 
        onClickRow: function(index, data) {
        	var row = $('#list_data').datagrid('getSelected');
        	window.parent.document.getElementById('serviceframe').src='Service.jsp?flowControolerActionId='+row.flowControolerActionId;
        },
        toolbar: [{ 
            text: '添加', 
            iconCls: 'icon-add', 
